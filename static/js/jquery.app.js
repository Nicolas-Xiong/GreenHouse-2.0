...
(jQuery,window),function($){sideNav.init()}(jQuery),$(document).on("change",'input[name="header-theme"]',function(){var context=$('input[name="header-theme"]:checked').val();$(".app").removeClass(function(index,className){return(className.match(/(^|\s)header-\S+/g)||[]).join(" ")}).addClass("header-"+context)});